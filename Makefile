all:
	$(CC) -g -c ./libtufnano.c -o build/libtufnano.o -I tuf_sample_client/ -I ../coreJSON/source/include -I ../mbedtls/include/ -fsanitize=address,leak,undefined,pointer-compare,pointer-subtract -fstack-protector -Wall
	...
	$(CC) -g -c ./tests/unit-test/libtufnano_utest.c -o build/libtufnano_utest.o  -I tuf_sample_client/  -I ../coreJSON/source/include -I ../Unity/src -I ../Unity/extras/fixture/src -I ../Unity/extras/memory/src -I . -I ../mbedtls/include/ -fsanitize=address,leak,undefined,pointer-compare,pointer-subtract -fstack-protector
